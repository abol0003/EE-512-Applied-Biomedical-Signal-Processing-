...
IF_Hilbert = IFhilbert(V3,50);
[IF_Teager,~] = teager(V3,50);

figure
subplot(511), plot(t, IF_Hilbert), title('IF\_Hilbert on raw V3 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(512), plot(t, IF_Teager), title('IF\_Teager on raw V3 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(513), plot(t, IF_STFT), title('IF\_STFT on raw V3 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(514), plot(t, IF_Adapt_1), title('IF\_Adapt on raw V3 signal, beta = 0.85'), xlabel('Time [s]'), ylim([0 15])
subplot(515), plot(t, IF_Adapt_2), title('IF\_Adapt on raw V3 signal, beta = 0.98'), xlabel('Time [s]'), ylim([0 15])
...
IF_Hilbert = IFhilbert(V4,50);
[IF_Teager,~] = teager(V4,50);

figure
subplot(511), plot(t, IF_Hilbert), title('IF\_Hilbert on raw V4 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(512), plot(t, IF_Teager), title('IF\_Teager on raw V4 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(513), plot(t, IF_STFT), title('IF\_STFT on raw V4 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(514), plot(t, IF_Adapt_1), title('IF\_Adapt on raw V4 signal, beta = 0.85'), xlabel('Time [s]'), ylim([0 15])
subplot(515), plot(t, IF_Adapt_2), title('IF\_Adapt on raw V4 signal, beta = 0.98'), xlabel('Time [s]'), ylim([0 15])
...
IF_Hilbert = IFhilbert(V3_filt,50);
[IF_Teager,~] = teager(V3_filt,50);

figure
subplot(511), plot(t, IF_Hilbert), title('IF\_Hilbert on filtered V3 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(512), plot(t, IF_Teager), title('IF\_Teager on filtered V3 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(513), plot(t, IF_STFT), title('IF\_STFT on filtered V3 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(514), plot(t, IF_Adapt_1f), title('IF\_Adapt on filtered V3 signal, beta = 0.85'), xlabel('Time [s]'), ylim([0 15])
subplot(515), plot(t, IF_Adapt_2f), title('IF\_Adapt on filtered V3 signal, beta = 0.98'), xlabel('Time [s]'), ylim([0 15])
set(gcf, 'Name', 'IF estimation on filtered V3 signal')

IF_STFT = STFT(V4_filt,31,50);
[IF_Adapt,y] = AdaptBP(V4_filt,4,0.95,0.9,50,0);
IF_Hilbert = IFhilbert(V4_filt,50);
[IF_Teager,~] = teager(V4_filt,50);

figure
subplot(411), plot(t, IF_Hilbert), title('IF\_Hilbert on filtered V4 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(412), plot(t, IF_Teager), title('IF\_Teager on filtered V4 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(413), plot(t, IF_STFT), title('IF\_STFT on filtered V4 signal'), xlabel('Time [s]'), ylim([0 15])
subplot(414), plot(t, IF_Adapt), title('IF\_Adapt on filtered V4 signal'), xlabel('Time [s]'), ylim([0 15])
